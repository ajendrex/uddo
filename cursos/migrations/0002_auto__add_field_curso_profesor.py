...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Curso.profesor'
        db.add_column('cursos_curso', 'profesor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cursos_prof', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Curso.profesor'
        db.delete_column('cursos_curso', 'profesor_id')
    ...
    models = {
        ...
        'cursos.comentariocurso': {
            ...
            'fec_creacion': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cursos.curso': {
            ...
            'fec_creacion': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'fec_modificacion': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
